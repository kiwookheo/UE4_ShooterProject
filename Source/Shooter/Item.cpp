...
void AItem::OnConstruction(const FTransform& Transform)
{
	...
	// Path to the Item Rarity Data Talbe
...
void AItem::UpdatePulse()
{
	...
	if (DynamicMaterialInstance)
	{
		DynamicMaterialInstance->SetScalarParameterValue(TEXT("GlowAmount"), CurveValue.Y * GlowAmount);
